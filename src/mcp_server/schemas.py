...
class WbDailyOperationalSummaryResponse(ApiModel):
    ...
    operating_profit_context: dict[str, Any] = Field(default_factory=dict)
    logistics_summary: dict[str, Any] = Field(default_factory=dict)
    pricing_spp_context: dict[str, Any] = Field(default_factory=dict)
    competitor_context: dict[str, Any] = Field(default_factory=dict)
    additional_data_candidates: list[dict[str, Any]] = Field(default_factory=list)
