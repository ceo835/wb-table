...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Import WB orders-geography XLSX into fact_localization_region_day.")
    parser.add_argument("--file", required=True, help="Path to WB orders-geography xlsx export.")
...
def main() -> int:
    ...
    result = import_orders_geography_xlsx(
        args.file,
