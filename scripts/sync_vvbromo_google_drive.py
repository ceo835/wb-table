...
def main() -> int:
    parser = argparse.ArgumentParser(description="Sync VVBROMO files from Google Drive.")
    ...
    summary = sync_vvbromo_from_google_drive(run_date=run_date, write_db=args.apply)
